...
function onIntent(intentRequest, session, callback) {
    ...
    if ("getMailIntent" === intentName) {
        getMail(intent, session, callback);
...
function getMail(intent, session, callback) {
    ...
    var shouldEndSession = true;
        ...
        var url = "http://HOST_NAME/path/to/gmail.php?code=CUSTOM_VALIDATION_CODE"
        console.log(url);
        http.get(url, function(res) {
            ...
            res.on('end', function () {
                ...
                if (stringResult == "") {
                    speechOutput = "You don't have any new mail in your inbox"
                } else {
                    speechOutput = stringResult;
                }
